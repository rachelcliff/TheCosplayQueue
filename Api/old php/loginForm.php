...
<head>
    ...
    <body>
      ...
      <ul id="slide-out" class="sidenav">
        ...
        <div id=details action="processLogin" method="POST">  
          <div class="row">
                <form class="col s12 m12">
                    ...
                    <div class="input-field col offset-s1 s10" id="password">
                      ...
                      <button class="btn waves-effect waves-light col offset-s1 s4 modal-trigger" type="submit" name="action" id="submit-btn" href="#modal1">Log In
                ...
                <a class="waves-effect waves-light btn col offset-s2 s4" id="signup-btn" href="signUpForm.php"><i class="material-icons left">create</i>Sign Up</a>
              </div>
    ...
    <div id="modal2" class="modal bottom-sheet">
      <div class="modal-content">
        ...
        <div id=details-form action="updateReg" method="POST">  
          <div class="row">
                <form class="col s12 m12">
                    <div class="input-field col offset-s1 s10" id="name">
                      <i class="material-icons prefix">account_circle</i>
